...
def makeMap(brand, store, getInfo):
    ...
    marker = folium.Marker([latitude, longitude], popup=shopinfo, icon=folium.Icon(color=mycolor, icon='info-sign'))
    marker.add_to(mapObject)
...
brand = 'pelicana'
condition1 = myframe['gungu'] == where
condition2 = myframe['brand'] == brand
